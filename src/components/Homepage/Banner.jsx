  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex space-x-6">
        <div className="h-[494px] w-[584px]  mt-[152px]">
          <h1
          ...
          <div className="mt-5 relative">
            <input
              ...
              className="bg-white w-full border border-[#ED6923] pl-2.5 h-[64px] rounded-bl-2xl rounded-tl-2xl rounded-br-2xl rounded-tr-2xl"
              class="flex-grow text-gray-700 placeholder-gray-400 focus:outline-none"
            />

            <button className="bg-[#ED6923] w-[159px] h-[64px] text-white font-semibold rounded-br-2xl rounded-tr-2xl absolute right-0">
              Find Food
            </button>
            <div className="flex space-x-1.5 items-center hover:underline absolute right-48 top-5">
              <img src="vector (12).png" alt="" />
              <h1 className="text-[#ED6923]">Locate me</h1>
            </div>
          </div>
          {/* <!-- Locate Me Button --> */}
          {/* <button class="flex space-x-1.5 items-center text-orange-500 text-sm px-3 hover:underline">
              <img src="vector (12).png" alt="" />
              <h1>Locate me</h1>
            </button> */}
        </div>
        <div className="h-[533px] w-[590px] mt-[85px] relative">
          <img src="Untitled design (1) 1.png" alt="" />
          ...
          <div className="border border-[#FFFFFF80] backdrop-blur-lg  bg-white/30 shadow-lg w-[322px] h-[140px] rounded-[14px] absolute bottom-[-74] left-2 p-3">
          ...
          <div className="bg-pink-100 shadow-lg w-[161px] h-[83px] rounded-[14px] absolute bottom-[-20] right-0 p-3">
