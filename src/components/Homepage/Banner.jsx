...
export default function Banner() {
  return (
    <div
      className="h-[791px] mt-6 px-4 md:px-0"
      style={{
        background:
          "linear-gradient(to left, rgba(253, 237, 229, 1), rgba(254, 140, 79, 0.2), rgba(254, 140, 79, 0.2))",
      }}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-6">
        {/* Left section (text + input) */}
        <div className="h-[494px] w-full md:w-[584px]  mt-2.5 md:mt-[152px]">
          <h1
            className={`${rancho.className} text-[40px] md:text-[100px] font-normal text-[#ED6923]`}
          >
            Hungry?
          </h1>
          <h1 className="text-[40px] md:text-[72px] font-bold text-[#ED6923]">
        ...
        <div className="h-[533px] w-full md:w-[590px] -mt-30 md:mt-[85px] relative mx-auto md:mx-0">
          <img
            src="Untitled design (1) 1.png"
            alt=""
            className="w-full h-auto"
          />
          {/* Satisfied Customer Card - Hide on mobile */}
          <div className="w-[194px] h-[150px] rounded-[14px] bg-white absolute top-0 left-5 p-3 hidden sm:block">
          ...
          <div className="border border-[#FFFFFF80] backdrop-blur-lg bg-white/30 shadow-lg w-[322px] h-[140px] rounded-[14px] absolute md:bottom-[-74px] left-9 md:left-2 p-3">
          ...
          {/* 24/7 Delivery Card - Hide on mobile */}
          <div className="bg-pink-100 shadow-lg w-[161px] h-[83px] rounded-[14px] absolute bottom-[-20px] right-0 p-3 hidden sm:flex">
